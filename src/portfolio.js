...
const seo = {
  ...
  og: {
    title: "Chaitanya Hathidara Portfolio",
    type: "website",
...
const greeting = {
  ...
  // portfolio_repository: "https://github.com/Chaitanya276/masterPortfolio",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Developing highly secure and user-driven project for various deeplearning and statistical use cases",
...
const degrees = {
  degrees: [
    ...
    },
    {
      ...
      alt_name: "Maharashtra State Board of Secondary and Higher Secondary Education",
      duration: "2016 - 2018",
      descriptions: [
